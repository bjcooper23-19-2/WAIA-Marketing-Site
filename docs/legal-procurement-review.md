...
Shared documents now have canonical destinations on the live HTTPS estate at
`https://legal.nineteenpointtwo.com/`. WAIA links directly to that estate;
`/terms/`, `/ai-use-statement/` and `/data-privacy/` remain WAIA-owned pages.
All five new destinations returned HTTP 200. No legacy redirects have yet been
introduced as part of this migration. This resolves WAIA's link-destination
dependency, not the outstanding owner confirmations for issue #7. The document
versions and findings below reflect the current standalone estate, including
the content corrections confirmed by its owner. They are not a certification
of supplier controls or production configuration.
...
| -------------------------------------------------------------------- | --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Privacy Notice](https://legal.nineteenpointtwo.com/privacy/)        | 1.1, 9 September 2026 | Includes WAIA workflow/application evidence alongside learner/admin records. The earlier missing-scope finding is resolved. Controller/processor roles, company details, retention and international-transfer qualifications remain stated; Tally's supplier/privacy role still requires owner confirmation.                     |
| [Cookie Notice](https://legal.nineteenpointtwo.com/cookies/)         | 1.1, 9 September 2026 | Includes a factual description of WAIA's sessionStorage enquiry-source attribution, alongside cookieless Cloudflare measurement. The disclosure omission is resolved. Legal consent/exemption treatment remains for owner confirmation; the description does not itself establish an exemption.                                  |
| [DPA](https://legal.nineteenpointtwo.com/data-processing-agreement/) | 1.1, 9 September 2026 | Includes workflow evidence, grouping, review records and snapshots. The earlier processing-scope omission is resolved. Section 16 gives precedence for Customer Personal Data processing. Supplier agreements and exact production configuration remain to be confirmed separately.                                              |
| [Security Summary](https://legal.nineteenpointtwo.com/security/)     | 1.0, 27 May 2026      | Appropriately avoids certification/uptime guarantees. Backup frequency, retention, restore arrangements and provider evidence are explicitly matters to confirm, not verified controls. Keep these as procurement questions until the operator supplies evidence.                                                                |
| [Subprocessors](https://legal.nineteenpointtwo.com/subprocessors/)   | 1.1, 9 September 2026 | Confirm Resend production activation and its direct/indirect supplier role, data scope, agreements and transfer safeguards. Tally's supplier/privacy role also requires owner confirmation; do not assume it is a learner-data subprocessor. Published descriptions do not independently verify active production configuration. |

The standalone estate resolves the earlier legacy marketing-header and WAIA-link
finding. No shared document was copied into or edited from this repository;
ownership of shared-document content remains separate.
