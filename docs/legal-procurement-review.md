...
| Data & Privacy summary                                           | Model-training summary referred to all customer data, while the detailed statement and terms specify Customer Personal Data. | Qualify the summary to customer personal data, preserving the intentional-use boundary.                                                                                                                                                                                                                |
...
- Existing AI processing exceptions and intentional no-training wording were
  retained. No new AI provider, zero-retention, residency or certification claim
